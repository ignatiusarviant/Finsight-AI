...
def extract_pdf_text(pdf_file):
            ...
            with pdfplumber.open(pdf_file) as pdf:
                ...
                for page in pdf.pages:
                    ...
                    if page_text:
                        text += page_text + "\n"
                if text.strip():
                    st.success("✅ Berhasil membaca PDF dengan pdfplumber!")
                    return text
        except Exception as e:
            st.warning(f"⚠️ pdfplumber juga gagal: {str(e)}")
    ...
    if PDFMINER_AVAILABLE:
        try:
            ...
            if text.strip():
                st.success("✅ Berhasil membaca PDF dengan pdfminer!")
                return text
        except Exception as e:
            st.warning(f"⚠️ pdfminer juga gagal: {str(e)}")
